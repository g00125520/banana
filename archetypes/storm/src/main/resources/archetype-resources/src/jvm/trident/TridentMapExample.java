...
/**
 * A simple example that demonstrates the usage of {@link org.apache.storm.trident.Stream${symbol_pound}map(MapFunction)} and
 * {@link org.apache.storm.trident.Stream${symbol_pound}flatMap(FlatMapFunction)} functions.
 */
