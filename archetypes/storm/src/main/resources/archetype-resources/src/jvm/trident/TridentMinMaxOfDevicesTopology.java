...
import ${package}.spout.RandomNumberGeneratorSpout;
 ...
 * * {@link Stream${symbol_pound}minBy(String)}
 * * {@link Stream${symbol_pound}maxBy(String)}
...
public class TridentMinMaxOfDevicesTopology {
    ...
    public static StormTopology buildDevicesTopology() {
        ...
        Stream devicesStream = topology
                ...
                .each(allFields, new Debug("${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound} devices"));

        devicesStream
                .minBy(deviceId)
                .each(allFields, new Debug("${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound} device with min id"));

        devicesStream
                .maxBy(count)
                .each(allFields, new Debug("${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound} device with max count"));
    ...
    public static StormTopology buildVehiclesTopology() {
        ...
        vehiclesStream
                ...
                .each(vehicleField, new Debug("${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound} efficient vehicle"));
